...
class ResNet_Torch(nn.Module):
    ...
    def forward(self, x):
        ...
        #dauer_ms = (end - start) * 1_000  # Sekunden → Millisekunden
        #print(f"Dauer: {dauer_ms:.2f} Millisekunden")
        return policy, value
...
class AlphaZero:
    def __init__(self, model, optimizer, game, args):
        ...
        self.game = game
        self.args = args
        self.mcts = MCTS_Torch(game, args, model)
...
class TorchAgent:
    def __init__(self, model, args):
        ...
        self.model = model
        self.args = args
        self.mcts = MCTS_Torch(self.game, args, model)
